DELIMITER $$
CREATE PROCEDURE `get_dashboard_by_currency`(IN dashboard_base_table_name VARCHAR(45))
BEGIN
...
AS
(
SELECT currency, SUM(balance_before) AS balance_before, SUM(balance_current) AS balance_current, 
...
INSERT INTO overall
SELECT 'TOKEN' AS currency, SUM(balance_before) AS balance_before, SUM(balance_current) AS balance_current, 
